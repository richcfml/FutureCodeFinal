<x-admin-layout>
    ...
    <div class="page-head">
        <div class="wrap">
            <span class="eyebrow"><span class="dot"></span> Register</span>
    ...
    <section class="form-section">
        <div class="wrap">
            ...
            <form method="POST" action="{{ route('register.store') }}" id="intake-form" novalidate>
                @csrf
                ...
                <div class="form-footer">
                    <button type="submit" class="btn btn-primary" id="submit-btn">Register<span class="mono" aria-hidden="true"> →</span></button>
                </div>
            </form>
